    ...
    if (y1 - y0 != 0) {
        for (int y = y0; y <= y1; y++) {
            ...
            for (int x = x_start; x < x_end; x++) {
                ...
                draw_triangle_texel(x, y, display, texture, point_a, point_b, point_c, a_uv, b_uv, c_uv);
            }
        }
    }
...
//
///////////////////////////////////////////////////////////////////////////////
void triangle_t::draw_filled_triangle(Display& display, int x0, int y0, float z0, float w0,
    ...
    if (y1 - y0 != 0) {
        for (int y = y0; y <= y1; y++) {
            ...
            for (int x = x_start; x < x_end; x++) {
                ...
                draw_triangle_pixel(x, y, color, point_a, point_b, point_c, display);
            }
        }
    }
